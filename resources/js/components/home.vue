         ...
         <main>
            ...
            <div class="popular-items section-padding30">
                <div class="container">
                    ...
                    <div class="row">
                        <div  class="col-xl-4 col-lg-4 col-md-6 col-sm-6" v-for="catagory in data.slice(0, 6)" :key="catagory.id">
                           <div class="single-popular-items mb-50 text-center">
                                    <div class="popular-img">
                                        ...
                                        <div class="img-cap">
                                         ...
                                         <router-link :to="{ name: 'deatelse',params:{id:catagory.id} }"><span>Add to cart</span></router-link>
                                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="room-btn pt-70">
                            <router-link to="shop" class="btn hero-btn">View More Products</router-link>
                    ...
                    <div class="row align-items-center justify-content-between padding-130">
                        <div class="col-lg-5 col-md-6">
                            <div class="watch-details mb-40">
                               ...
                               <router-link to="/shop" class="btn">Show Watches</router-link>
                            </div>
                        </div>
